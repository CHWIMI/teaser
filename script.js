...
const POSTS = [
    {
        ...
        content: `
            ...
            <p>현재 세렝게티 동쪽숲에서 몰랑쿤의 10배나 차이나는 크기의 그림자가 목격돼 출입을 제한합니다.</p>
            <br>
            <p><strong>1. 제한 구간:</strong> 세렝게티 동쪽 숲 ~ 북동쪽 용의 협곡역 (약 12km)</p>
            <p><strong>2. 제한 기간:</strong> 2026.04.01(화) ~ 복구 완료 시까지</p>
            <p><strong>3. 우회도로:</strong> 은빛 숲 순환도로 → 달빛 지하 교차로 → 왕성 방면</p>
            <p><strong>4. 비상 연락처:</strong> 세렝게티 도로관리공단 ☎ 1588-몰랑몰랑 ~ 몰루몰루</p>
            <p><strong>5. 담당자:</strong> 김몰랑, 아몰랑</p>
            <br>
    ...
    {
        id: 4,
        title: '세렝게티 건국 기념 빛과 소리의 연회 안내',
        author: '문화예술과',
        date: '2026-04-03',
        status: '진행중',
        content: `
            <h3>세렝게티 건국 기념 빛과 소리의 연회 안내</h3>
            <p>세렝게티 건국 기념일을 맞이하여, 왕국의 밤을 수놓을 신비로운 연회에 국민 여러분을 초대합니다.</p>
            <br>
            <p><strong>1. 일시 및 장소:</strong> 2026.04.09(목) 19:00 / 세렝게티 대극장</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p>제1치즈 농장에서 대지의 마력을 빌려 황금빛 유가공 결정체를 밭에서 직접 피워내는 특별한 비전 교육을 실시합니다.</p>
            <br>
            ...
            <p><strong>3. 신청 대상:</strong> 세렝게티 농업 종사자 및 치즈를 사랑하는 주민 누구나</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p>왕립 마법공학연구소의 최신 모션 캡처 기술 시연을 위해, 공주님의 특별 단독 생방송이 긴급 편성되었습니다.</p>
            <br>
